...
//console.log(conteoPalabras("Hola me llamo Luis"));
//console.log(deleteFirst([1,2,3,1,2,1],2))
//console.log(maximoMinimo([1,2,3,4]));
//console.log(IndexFirstElement([1,2,3,1],1));
//console.log(splitFrags([1,2,3,4],2));
//console.log(extraerPropiedades({Nombre: "Luis"},["Nombre"]));
